...
def create_event(request):
    if request.method == 'POST':
        ...
        return render(request, 'main/create_event.html', {'categories': categories})
...
def update_event(request, event_id):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'main/update_event.html', {'event': event})
...
def category_events(request, category_id):
    ...
    return render(request, 'main/category_events.html', {'category': category, 'events': events})
...
def event_chart(request):
    ...
    return render(request, 'main/event_chart.html', {'pending_counts': pending_counts})
